...
export interface CatalogResponse { catalogAsOf: string; mode: Mode; demoMode: boolean; status: FreshnessStatus; summary: { total: number; live: number; stale: number; unavailableProviders: string[] }; opportunities: Opportunity[]; notices: string[]; }
